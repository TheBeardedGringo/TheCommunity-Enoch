...
SET MODIDS=1559212036,1564026768,1574054508,1576057168,1590841260,1710977250,1724005476,1623711988,1928939749,1585487785,1927567004,1782854982
:: Add the Mod Name WITH the @ symbol close it with the ; as usual
SET MODNAMES=@CF;@Community-Online-Tools;@BuildAnywhere;@BaseBuildingLogs;@Trader;@BaseBuildingPlus;@Durable Supressors;@VanillaPlusPlusMap;@Ear-Plugs;@Catch_Rain;@DayZ-Expansion-Notifications;@DayZ-Expansion-Chat;@No Shoe Damage
...
SET MOD[1782854982]=No Shoe Damage
:: ********************************************************************************
